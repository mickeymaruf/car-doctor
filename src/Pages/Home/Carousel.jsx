    ...
    return (
        <div className='relative'>
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-24 text-white w-4/12">
                ...
                <a href="#slide3" className="btn btn-theme-outline rounded-md mr-3">Discover More</a>
                <a href="#slide1" className="btn bg-transparent border-base-100 text-white hover:bg-[] rounded-md">Latest Project</a>
            </div>
        </div>
    );
};
    ...
    return (
        <div id={`slide${_id}`} className="carousel-item w-full relative carousel-image">
            ...
            <div className="absolute flex gap-5 justify-between transform -translate-y-1/2 right-16 bottom-5 z-10">
                <a href={`#slide${prev}`} className="btn btn-circle btn-theme">❮</a>
                <a href={`#slide${next}`} className="btn btn-circle btn-theme">❯</a>
            </div>
        </div>
    );
}
